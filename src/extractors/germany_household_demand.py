...
class GermanyHouseholdDemandExtractor:
    def __init__(self):
        self.config = Config()
        self.logger = logging.getLogger(__name__)
        self.source = 'bundesnetzagentur'
        self.historic_file = 'src/data/processed/germany_household_historic.csv'
...
if __name__ == "__main__":
    ...
    extractor = GermanyHouseholdDemandExtractor()
    df = extractor.get_demand_data()
    print("\nSample of extracted German household demand data:")
    print(df.head()) 